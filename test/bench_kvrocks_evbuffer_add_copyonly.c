/*
 * Benchmark the Kvrocks-like fragment selection and memcpy pattern without
 * evbuffer bookkeeping.
 */
...
main(int argc, char **argv)
{
	...
	max_len = (size_t)value_size;
	if (header_len > max_len)
		max_len = header_len;
	if (max_len < 5)
		max_len = 5;
	max_batch_bytes = (size_t)BATCH_OPS * max_len;
