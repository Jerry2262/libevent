 ...
 *
 * This is not an evbuffer API benchmark.  It is a lower-bound probe for the
 * memcpy-adjacent control flow and metadata updates in evbuffer_add().
 */
...
main(int argc, char **argv)
{
	...
	printf("bench=evbuffer_add_fixed128_shortpath ops=%ld bytes=" U64_FMT
